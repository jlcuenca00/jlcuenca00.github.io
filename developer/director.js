document.addEventListener("DOMContentLoaded", () => {
  ...
  function initAffiliationSwitchboard() {
    // Affiliation markup is rebuilt by director-mosaic.js into the two-chapter editorial spread.
  }
